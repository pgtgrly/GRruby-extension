...
describe Rubyplot::Figure do
  ...
  context '#bar' do
    ...
    it 'creates a bar graph with orange color bars with spaces' do
      ...
      a.save 'spec/reference_images/single_plot_graph/blue_spaced_bar_graph.bmp'
  ...
  context '#line_plot!' do
    it 'creates a simple line plot' do
      ...
      a.save 'spec/reference_images/single_plot_graph/line_plot.bmp'
    end

    it 'creates a line plot with red markers' do
      a = Rubyplot::Figure.new
      a.line_plot! @values, marker_color: :red, marker_size: 2
      a.save 'spec/reference_images/single_plot_graph/red_line_plot.bmp'
    ...
    it 'creates a line plot with green solid bowtie markers' do
      ...
      a.save 'spec/reference_images/single_plot_graph/green _bowtie_line_plot.bmp'
    end
  end
  ...
  context '#pie!' do
    it 'creates a simple pie chart' do
      ...
      a.save 'spec/reference_images/single_plot_graph/pie_chart.bmp'
    end
  end
